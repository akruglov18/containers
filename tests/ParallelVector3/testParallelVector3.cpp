...
typedef testing::TestWithParam<std::tuple<size_t, size_t>> TestParallelVector3;
TEST_P(TestParallelVector3, push_back) {
...
INSTANTIATE_TEST_SUITE_P(/**/, TestParallelVector3, 
    testing::Combine(
